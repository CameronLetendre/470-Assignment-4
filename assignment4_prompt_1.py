...
def generate_relevance_score_pipeline(query, doc_text):
    ...
    prompt = (
        f"On a scale from 0 to 2, rate the relevance of the following document to the query. "
...
format_to_trec("generated_scores_1.tsv", "prompt1_1.tsv", run_id="run1")
format_to_trec("generated_scores_2.tsv", "prompt1_2.tsv", run_id="run2")
